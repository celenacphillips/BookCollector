...
namespace BookCollector.Data.Models
{
    ...
    public partial class GenreModel : GenreDatabaseModel, ICloneable
    {
        ...
        public async Task SetTotalBooks(
            ...
            bool showPaperbacks)
        {
            var list = await FillLists.GetAllBooksInGenreList(this.GenreGuid, showHiddenBooks, showAudiobooks, showEbooks, showHardcovers, showPaperbacks);
        ...
        public async Task SetTotalCostOfBooks(
            ...
            bool showPaperbacks)
        {
            this.TotalCostOfBooks = await GetCounts.GetAllBookPricesInGenreList(this.GenreGuid, showHiddenBooks, showAudiobooks, showEbooks, showHardcovers, showPaperbacks);
        }
    }
}
