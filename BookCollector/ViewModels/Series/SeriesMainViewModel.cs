...
namespace BookCollector.ViewModels.Series
{
    ...
    /// <summary>
    /// SeriesMainViewModel class.
    /// </summary>
    public partial class SeriesMainViewModel : SeriesViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesMainViewModel"/> class.
        /// </summary>
        /// <param name="series">Series to view.</param>
        ...
        public async Task SetList(
            ...
            bool showPaperbacks)
        {
            this.FullBookList ??= await FillLists.GetAllBooksInSeriesList(this.SelectedSeries?.SeriesGuid, showHiddenBooks, showAudiobooks, showEbooks, showHardcovers, showPaperbacks);
        ...
        /// <summary>
        /// Show the existing books view to add an existing book to the series.
        /// </summary>
        /// <returns>A task.</returns>
        [RelayCommand]
        public async Task AddExistingBook()
        {
            await this.ShowExistingBookView(this.SelectedSeries!);
        }
        ...
        public override bool GetPreferences()
        {
            ...
            this.SeriesOrderChecked = Preferences.Get($"{this.ViewTitle}_{DevicePreferences.SeriesOrderSortSelection}", (bool)this.SeriesOrderCheckedDefault! /* Default */);
        ...
        public override SortPopupViewModel SetSortPopupValues(SortPopupViewModel viewModel)
        {
            ...
            /******************************/
            viewModel.SeriesOrderVisible = true;
            viewModel.SeriesOrderChecked = this.SeriesOrderChecked;
            /******************************/
        ...
        {
            this.BookTitleCheckedDefault = false;
            this.SeriesOrderCheckedDefault = true;
