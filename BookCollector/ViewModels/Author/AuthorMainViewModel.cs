...
namespace BookCollector.ViewModels.Author
{
    ...
    public partial class AuthorMainViewModel : AuthorsViewModel
    {
        ...
        public async Task SetList(
            ...
            bool showPaperbacks)
        {
            this.FullBookList ??= await FillLists.GetAllBooksInAuthorList(this.SelectedAuthor!.AuthorGuid, ShowHiddenBooks, showAudiobooks, showEbooks, showHardcovers, showPaperbacks);
        ...
        {
            await this.ShowExistingBookView(this.SelectedAuthor!);
        }
