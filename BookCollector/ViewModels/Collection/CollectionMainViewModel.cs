...
namespace BookCollector.ViewModels.Collection
{
    ...
    /// <summary>
    /// CollectionMainViewModel class.
    /// </summary>
    public partial class CollectionMainViewModel : CollectionsViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionMainViewModel"/> class.
        /// </summary>
        ...
        public async Task SetList(
            ...
            bool showPaperbacks)
        {
            this.FullBookList ??= await FillLists.GetAllBooksInCollectionList(this.SelectedCollection?.CollectionGuid, ShowHiddenBooks, showAudiobooks, showEbooks, showHardcovers, showPaperbacks);
        ...
        /// <summary>
        /// Show the existing books view to add an existing book to the collection.
        /// </summary>
        /// <returns>A task.</returns>
        [RelayCommand]
        public async Task AddExistingBook()
        {
            await this.ShowExistingBookView(this.SelectedCollection!);
        }
