// <copyright file="BorrowedBooksViewModel.cs" company="Castle Software">
...
namespace BookCollector.ViewModels.Main
{
    ...
    /// <summary>
    /// BorrowedBooksViewModel class.
    /// </summary>
    public partial class BorrowedBooksViewModel : BookListBaseViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BorrowedBooksViewModel"/> class.
        /// </summary>
        /// <param name="view">View related to view model.</param>
        public BorrowedBooksViewModel(ContentPage view)
        {
            this.View = view;
            this.CollectionViewHeight = DeviceHeight;
            this.InfoText = $"{AppStringResources.BorrowedBooksView_InfoText}";
            this.ViewTitle = AppStringResources.BooksBorrowed;
        ...
        public static async Task SetList(
            ...
            bool showPaperbacks)
        {
            fullBookList ??= await FillLists.GetBorrowedBooksList();
