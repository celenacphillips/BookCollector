...
namespace BookCollector.ViewModels.Library
{
    public partial class ReadViewModel : BookBaseViewModel
    {
        public ReadViewModel(ContentPage view)
        {
            ...
            ViewTitle = AppStringResources.Read;
        }
        ...
        public async Task SetViewModelData()
        {
            try
            {
                ...
                Task.WaitAll(
                [
                    Task.Run (async () => FullBookList = await FilterLists.GetReadBooksList(bookList, ShowHiddenBook) ),
                ]);
        ...
        private void GetPreferences()
        {
            ...
            BookTitleChecked = Preferences.Get($"{ViewTitle}_BookTitleSelection", false  /* Default */);
            BookReadingDateChecked = Preferences.Get($"{ViewTitle}_BookReadingDateSelection", true  /* Default */);
            ...
            AscendingChecked = Preferences.Get($"{ViewTitle}_AscendingSelection", false  /* Default */);
            DescendingChecked = Preferences.Get($"{ViewTitle}_DescendingSelection", true  /* Default */);
        }
    }
}
