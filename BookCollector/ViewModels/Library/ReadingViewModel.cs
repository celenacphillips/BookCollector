...
namespace BookCollector.ViewModels.Library
{
    ...
    public partial class ReadingViewModel : BookListBaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadingViewModel"/> class.
        /// </summary>
        ...
        private void SetSortPopupDefaults()
        {
            ...
            this.BookReadingDateCheckedDefault = true;
            ...
            this.AscendingCheckedDefault = false;
            this.DescendingCheckedDefault = true;
        }
    }
}
