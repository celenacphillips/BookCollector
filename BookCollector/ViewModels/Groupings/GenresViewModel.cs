    ...
    public partial class GenresViewModel : GroupingBaseViewModel
    {
        ...
        public override async Task SetViewModelData()
        {
            ...
            try
            {
                ...
                await SetList(DevicePreferences.ShowHiddenGenresValue);
        ...
        public override bool GetPreferences()
        {
            ...
            this.GenreNameChecked = Preferences.Get($"{this.ViewTitle}_{DevicePreferences.GenreNameSortSelection}", (bool)this.GenreNameCheckedDefault! /* Default */);
            ...
            return DevicePreferences.ShowHiddenGenresValue;
        }
